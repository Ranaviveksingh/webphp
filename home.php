          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul class="navbar-nav m-auto">
              ...
              <li class="nav-item km-cart px-0">
                <a class="nav-link" href="#">Cart <i aria-hidden="true" class="fa fa-shopping-cart fa-2x"></i> <span>1</span></a>
              </li>
 ...
 <!-- End -->
    ...
    <div class="footer-basic">
        <footer>
            ...
            <div class="text-center"><img class="img-fluid" src="assets/img/meetmefinal.png" style="height: 41px;"><a href="#" target="_blank">
                    <p class="copyright">meetind.me</p>
